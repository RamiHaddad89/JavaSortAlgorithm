						...
						.addGroup(groupLayout.createSequentialGroup().addGroup(groupLayout
								...
								.addGroup(groupLayout.createSequentialGroup().addComponent(valueLabel)
										...
										.addComponent(indexLabel, GroupLayout.PREFERRED_SIZE, 87,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(arrayIndexTextField,
								...
								.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
										.addGroup(groupLayout.createSequentialGroup().addComponent(insertButton)
												.addGap(26).addComponent(deleteButton).addGap(26)
						...
						.addGroup(
								groupLayout.createParallelGroup(Alignment.TRAILING)
										.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
												.addComponent(valueLabel).addComponent(insertButton)
												.addComponent(deleteButton).addComponent(findButton)
												.addComponent(arrayValueTextField, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
										.addGroup(groupLayout.createSequentialGroup()
												.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
														.addComponent(indexLabel, GroupLayout.PREFERRED_SIZE, 36,
																GroupLayout.PREFERRED_SIZE)
														.addComponent(arrayIndexTextField, GroupLayout.PREFERRED_SIZE,
	...
	class FindButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			try {
				...
				} else if (theView.binarySearchRadioButton.isSelected()) {
